    ...
    body: JSON.stringify({
      ...
      systemInstruction: {
        parts: [{
          text: [
            '너는 학습앱의 자기설명 코치다.',
            '개념 본문과 모범 설명(modelExplanation)을 기준으로, 학습자가 자신의 언어로 쓴 "왜?" 자기설명이 핵심 원리/구분을 담았는지 판단한다.',
            '표현·어휘·문장력은 관대하게 보고, 핵심 인과나 구분을 담았으면 sufficient=true.',
            '핵심이 빠졌거나 틀렸으면 sufficient=false로 하되 무엇을 한 줄 보태면 좋을지 짚어준다.',
