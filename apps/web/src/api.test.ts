...
describe('submitAnswer', () => {
  it('답안 제출 POST + result 반환', async () => {
    fetchMock.mockResolvedValueOnce(jsonResponse({ ok: true, result: { cardId: 'c1', score: 1, grade: 'good', correct: true, graderMode: 'llm', reason: 'ok', answer: 'a', explanation: 'e', dueAt: '2026-06-12T00:00:00.000Z', stage: 'consolidating' } }))
